...
class VerifyPickupSheetWidget extends StatefulWidget {
  final OrderModel? orderModel;
  const VerifyPickupSheetWidget({Key? key, this.orderModel}) : super(key: key);
  @override
  State<VerifyPickupSheetWidget> createState() => _VerifyPickupSheetWidgetState();
}

class _VerifyPickupSheetWidgetState extends State<VerifyPickupSheetWidget> {
 String otp = '';
        ...
        return Padding(padding:  EdgeInsets.all(Dimensions.paddingSizeLarge),
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Column(children: [
              ...
              Text('pickup_otp_verification'.tr, style: rubikBold, textAlign: TextAlign.center),
               SizedBox(height: Dimensions.paddingSizeLarge),

              Text('enter_pickup_otp_number'.tr, style: rubikRegular.copyWith(
              ...
              Text('collect_pickup_otp_from_vendor'.tr, style: rubikRegular, textAlign: TextAlign.center),
               SizedBox(height: Dimensions.paddingSizeLarge)]),
