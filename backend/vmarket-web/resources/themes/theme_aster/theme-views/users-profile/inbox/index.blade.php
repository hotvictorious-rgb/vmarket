                                        ...
                                        <div class="chat-list chatting-scrollbar">
                                            @if(isset($allChattingUsers) && count($allChattingUsers) > 0)
                                                @foreach($allChattingUsers as $key => $chatting)
                                                    ...
                                                    @php($userName = !is_null($chatting->admin_id) ? getInHouseShopConfig(key:'name') :  ($chatting?->seller_id ? $chatting?->seller?->shop->name : $chatting?->deliveryMan?->f_name ))
                                                    <div
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p class="fs-10 d-flex align-items-center justify-content-between">
                                                                @if($chatting->message)
                                                                    <span class="line-clamp-1">{{ $chatting->message }}</span>
                                ...
                                @if(isset($chattingMessages) && count($chattingMessages) > 0)
                                        ...
                                        <div class="media gap-2 align-items-center">
                                            <div class="avatar rounded-circle">
                                                <img alt=""
                                                     ...
                                                     loading="lazy"
                                                     src="{{ getStorageImages(path:($userType == 'admin' ? getInHouseShopConfig(key:'image_full_url') : $lastChatUser->image_full_url), type: 'avatar') }}">
                                            </div>
                                            <div class="media-body">
                                                <div class="d-flex flex-column gap-1">
                                                    <h6 id="name"
                                                        class="profile-name">{{ $userType == 'admin' ? getInHouseShopConfig(key:'name') : ($userType == 'vendor' ? $lastChatUser->name : ($lastChatUser?->f_name.' '.$lastChatUser?->l_name))  }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="messaging">
                                        <div style="--height: 52dvh"
                                             class="inbox_msg custom-scrollbar p-3 message-history h-100 scroll_msg mb-80"
                                            ...
                                            <form method="post" class="mt-4 chatting-messages-form form-advance-validation form-advance-file-validation"
                                                ...
                                                <div class="d-flex border bg--light">
                                                    <div
                                                        ...
                                                        <label class="py-0 m-0 cursor-pointer" id="record-audio-btn">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1455AC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                    ...
                                                    <div class="position-relative w-0 flex-grow-1">
                                                        <textarea
                                                            class="w-100 focus-input border-0 resize-none pt-2 bg-transparent text-black"
