    ...
    <li>
        @if(auth('customer')->check())
            <a href="{{ route('account-oder') }}"
               aria-label="{{ translate('orders') }}"
               class="d-flex align-items-center flex-column py-2 {{ Request::is('account-oder*') ? 'active' : '' }}">
                <div class="position-relative d-flex align-items-center justify-content-center" style="width: 26px; height: 26px;">
                    <i class="bi bi-bag-check fs-20 text-dark"></i>
                </div>
            </a>
        @else
            <a href="javascript:" aria-label="{{ translate('orders') }}" class="d-flex align-items-center flex-column py-2" data-bs-toggle="modal"
               data-bs-target="#loginModal">
                <div class="position-relative d-flex align-items-center justify-content-center" style="width: 26px; height: 26px;">
                    <i class="bi bi-bag-check fs-20 text-dark"></i>
                </div>
