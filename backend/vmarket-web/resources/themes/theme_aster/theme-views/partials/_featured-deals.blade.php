<section class="bg-primary-light flash-deal-dark-support">
    <div class="container">
        <div class="">
            <div class="py-4">
                <div class="d-flex flex-wrap justify-content-between gap-3 mb-3 mb-sm-4 text-capitalize">
                    ...
                    <div class="swiper-nav d-flex gap-2 align-items-center">
                        <div class="swiper-button-prev featured-deals-nav-prev position-static rounded-10"></div>
                        <div class="swiper-button-next featured-deals-nav-next position-static rounded-10"></div>
                    </div>
                </div>
                <div class="swiper-container">
                    <div class="position-relative">
                        <div class="swiper" data-swiper-loop="true" data-swiper-margin="20"
                             data-swiper-pagination-el="null" data-swiper-navigation-next=".featured-deals-nav-next"
                             data-swiper-navigation-prev=".featured-deals-nav-prev"
