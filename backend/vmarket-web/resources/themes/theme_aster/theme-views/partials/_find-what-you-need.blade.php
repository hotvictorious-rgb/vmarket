                        ...
                        <div class="swiper-container">
                            <div class="position-relative d-md-none">
                                <div class="swiper" data-swiper-loop="true" data-swiper-margin="16"
                                    data-swiper-speed="2000000" data-swiper-pagination-el="null"
                                    ...
                                    <div class="swiper-wrapper">
                                        @foreach($final_category as $key => $category)
                                            <div class="swiper-slide align-items-start bg-white">
                                                <div class="flexible-grid md-down-1 gap-3 w-100 width-1fr bg-light rounded overflow-hidden p-2">
                                                    <div class="rounded max-w-100-mobile overflow-hidden">
                                                        <div
                                                            ...
                                                            <a href="{{ route('category-products', ['slug' => $category['slug']]) }}" class="btn-link">
                                                                {{ translate('View_All') }}
                                            ...
                                            <h6 class="fs-12">
                                                ...
                                                @if($coupon->seller_id == '0')
                                                    ...
                                                    @else
                                                        ...
                                                        data-link="{{isset($coupon->seller->shop) ? route('vendor-shop',['slug'=>$coupon->seller->shop['slug']]) : 'javascript:'}}">
