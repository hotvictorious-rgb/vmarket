            ...
            <div class="container">
                ...
                <form method="POST" action="{{ url()->current() }}" class="product-list-filter">
                    ...
                    <div class="lg-down-1 gap-3 wid width--16rem">
                        <div class="">
                            <div class="card my-3">
                                <div class=" d-flex gap-4 flex-column flex-md-row align-items-center justify-content-between flex-wrap p-3">
                                    <div class="flash-deal-countdown text-center d-flex gap-2 align-items-center">
                                        <div class="mb-2 text-primary">
                                            <img width="122" src="{{ theme_asset('assets/img/media/flash-deal.svg') }}" loading="lazy" alt="" class="dark-support svg">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h2 class="text-primary fw-medium mb-1">{{ translate('hurry_up').'!' }}</h2>
                                            <div class="text-muted">{{ translate('offer_ends_in').':' }}</div>
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="d-flex align-items-center flex-md-nowrap pl-xl-20 flex-wrap justify-content-md-between justify-content-center gap-3">
