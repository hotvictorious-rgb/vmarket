                                        ...
                                        <div class="inbox_msg position-relative">
                                            <div class="mesgs">
                                                <a class="msg-user cursor-default" href="javascript:">
                                                    ...
                                                    @endif
                                                    <h5 class="m-0 profile-name">{{ $userType == 'admin' ? getInHouseShopConfig(key:'name') : ($userType == 'vendor' ? $lastChatUser->name : ($lastChatUser?->f_name.' '.$lastChatUser?->l_name))  }}</h5>
                                                </a>
                                               ...
                                               @if($canChat)
                                                    ...
                                                    <div class="input_msg_write">
                                                      @if(isset($userType) ? $userType != 'vendor' : request('type') != 'vendor')
                                                        <form
                                                            class="d-flex justify-content-center align-items-center md-form form-sm active-cyan-2 chatting-messages-form form-advance-validation form-advance-file-validation"
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="py-0 cursor-pointer" id="record-audio-btn">
