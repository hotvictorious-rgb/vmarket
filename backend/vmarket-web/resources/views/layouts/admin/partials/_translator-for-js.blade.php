...
<span id="role-name-required-message" data-error="{{ translate('name_field_is_required') }}"></span>
...
<span id="password-error-message" data-max-character="{{ translate('at_least_8_characters').'.' }}"
      ...
      data-symbol="{{ translate('at_least_one_symbol').'(!...%)'.'.' }}"
      data-confirm-password-match="{{ translate('confirm_password_does_not_match') }}"
></span>
...
<span id="message-loading-word" data-text="{{ translate('Loading') }}"></span>
