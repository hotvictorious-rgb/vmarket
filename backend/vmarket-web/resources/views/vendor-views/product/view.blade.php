...
@section('content')
        ...
        <div class="d-flex align-items-stretch justify-content-end flex-wrap gap-3 mb-3">
            ...
            <div class="d-flex align-items-stretch justify-content-end flex-wrap gap-3">
                ...
                @endif
                    ...
                    <button type="button" class="btn border text-danger bg-white icon-btn delete-data" style="--size: 40px;" title="{{ translate('delete') }}" data-id="product-{{ $product['id']}}">
                    ...
                    <a href="{{ route('vendor.products.update', [$product['id']]) }}" class="btn btn--primary min-w-120 h-40">
                                                            ...
                                                            <div class="position-absolute start-0 top-0 w-100 h-100 z-3 product-slide-overlay">
                                                                <div class="d-flex justify-content-center align-items-center h-100">
                                                                    <div class="p-3 d-flex justify-content-center align-items-center gap-3">
                                                                        <a data-lightbox="products-details-image" href="{{ $imagePath }}" class="btn btn-outline-success text-success bg-white icon-btn">
                                                                            <i class="fi fi-sr-eye"></i>
                                                                        </a>
                                                                        <button class="btn btn-outline--primary text--primary bg-white icon-btn" data-toggle="offcanvas" data-target="#offcanvasEditImages">
                        ...
                        <div class="d-flex gap-3 flex-column flex-lg-row overflow-wrap-anywhere">
                            ...
                            <div class="row gy-3 flex-grow-1">
                                <div class="col-sm-6 col-xl-4">
                                    <h4 class="mb-3 fs-14 text-capitalize">{{ translate('general_information') }}</h4>
                                    <div class="pair-list">
                                        @if($product?->product_type == 'physical' && isset($product->brand))
                                            <div>
                                                <span class="key text-nowrap fs-12 fs-12">{{ translate('brand') }}</span>
                                                <span>:</span>
                                                <span class="value text-dark fs-12">
                                        ...
                                        <div>
                                            <span class="key text-nowrap fs-12">{{ translate('category') }}</span>
                                            <span>:</span>
                                        ...
                                        <div>
                                            <span class="key text-nowrap fs-12">{{ translate('product_type') }}</span>
                                            <span>:</span>
                                            <span class="value fs-12 text-dark">{{ translate($product->product_type) }}</span>
                                        </div>
                                        @if($product->product_type == 'physical')
                                            <div>
                                                <span class="key text-nowrap fs-12 text-capitalize">{{ translate('product_unit') }}</span>
                                                <span>:</span>
                                                <span class="value fs-12 text-dark">{{ $product['unit']}}</span>
                                            </div>
                                            <div>
                                                <span class="key text-nowrap fs-12">{{ translate('current_Stock') }}</span>
                                                <span>:</span>
                                                <span class="value fs-12 text-dark">{{ $product->current_stock}}</span>
                                            </div>
                                        @endif
                                        <div>
                                            <span class="key text-nowrap fs-12">{{ translate('product_SKU') }}</span>
                                            <span>:</span>
                                            <span class="value fs-12 text-dark">{{ $product->code}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xl-4">
                                    ...
                                    <div class="pair-list">
                                        ...
                                        @if($product->discount > 0)
                                            <div>
                                                <span class="key text-nowrap fs-12">
                                                    {{ translate('discount') }}
                                                </span>
                                                <span>:</span>
                                                @if ($product->discount_type == 'percent')
                                                    <span class="value fs-12 text-dark">{{ $product->discount }}%</span>
                                                @else
                                                    <span class="value fs-12 text-dark">
                                ...
                                @if(count($product->tags)>0)
                                    <div class="col-sm-6 col-xl-4">
                                        <h4 class="mb-3 fs-14">{{ translate('tags') }}</h4>
                                        <div class="pair-list">
                                            <div>
                                                <span class="value fs-12 text-dark">
                    ...
                    <div class="card-body">
                        ...
                        @if ($product['video_url'])
                            ...
                            <div class="d-flex flex-wrap gap-3 align-items-center mt-4">
                                <a href="#video-view-modal" data-toggle="modal">
                                    <div class="position-relative h-100px w-180">
                                        ...
                                        <div class="position-absolute top-0 left-0 h-100 w-100 d-flex justify-content-center align-items-center">
                                            <button type="button" class="btn text-C2A7A7 bg-white btn-circle">
                                                <i class="fi fi-sr-play d-flex"></i>
                                            </button>
                                        </div>
                                    </div>
                                </a>
    ...
    @include('vendor-views.product.partials.modal._video-view-modal')
    @include('vendor-views.product.partials.offcanvas._edit-images-offcanvas',['product' => $product])
