                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label class="form-label d-flex align-items-center gap-2">
                                                ...
                                                <span class="tooltip-icon cursor-pointer" data-bs-toggle="tooltip"
                                                      data-bs-title="{{ translate('Global_Trade_Item_Number_(UPC,_EAN,_ISBN)._Required_for_high-ranking_Google_Shopping_listings.') }}">
                                                    <i class="fi fi-sr-info"></i>
                                                </span>
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label class="form-label d-flex align-items-center gap-2">
                                                ...
                                                <span class="tooltip-icon cursor-pointer" data-bs-toggle="tooltip"
                                                      data-bs-title="{{ translate('Alphanumeric_code_assigned_by_the_manufacturer_to_identify_the_product.') }}">
                                                    <i class="fi fi-sr-info"></i>
                                                </span>
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            <label class="form-label d-flex align-items-center gap-2">
                                                ...
                                                <span class="tooltip-icon cursor-pointer" data-bs-toggle="tooltip"
                                                      data-bs-title="{{ translate('Google_Taxonomy_numeric_category_ID_(e.g._1604_for_Apparel_&_Accessories)._Helps_Google_accurately_categorize_your_feed.') }}">
                                                    <i class="fi fi-sr-info"></i>
                                                </span>
                                            </label>
                                            <input type="number" name="google_category_id" class="form-control"
                                                   value="{{ old('google_category_id') }}"
