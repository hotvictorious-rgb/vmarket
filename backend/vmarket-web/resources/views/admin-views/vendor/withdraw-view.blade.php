                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2 mb-md-0">
                                ...
                                @if($withdrawRequest->proof_of_payment)
                                    <div class="mt-2">
                                        <h5 class="text-capitalize">{{translate('proof_of_payment')}}:</h5>
                                        <a href="{{asset('storage/app/public/withdraw_requests')}}/{{$withdrawRequest->proof_of_payment}}" target="_blank">
                                            <img src="{{asset('storage/app/public/withdraw_requests')}}/{{$withdrawRequest->proof_of_payment}}" alt="Proof of Payment" class="img-fluid" style="max-height: 100px;">
                                        </a>
                                    </div>
                                @endif
                            </div>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{route('admin.vendors.withdraw_status',[$withdrawRequest['id']])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">{{translate('request')}}:</label>
                                    <select name="approved" class="custom-select" id="inputGroupSelect02" onchange="toggleProofField(this.value)">
                                        <option value="1">{{translate('approve')}}</option>
                                        <option value="2">{{translate('deny')}}</option>
                                    </select>
                                </div>
                                <div class="form-group" id="proof-field">
                                    <label for="proof_of_payment" class="col-form-label">{{translate('proof_of_payment')}} ({{translate('required')}}):</label>
...
@push('script_2')
    <script>
        function toggleProofField(value) {
            const field = document.getElementById('proof-field');
