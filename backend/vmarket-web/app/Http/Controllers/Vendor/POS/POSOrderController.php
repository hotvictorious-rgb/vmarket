...
class POSOrderController extends BaseController
{
    ...
    public function getOrderDetails(string $id): View|RedirectResponse
    {
        ...
        // [AI] Ownership Guard: Only allow vendor to view their own POS orders
        $order = $this->orderRepo->getFirstWhere(params: ['id' => $id, 'seller_id' => $vendorId], relations: ['details', 'shipping', 'seller']);
        if (!$order) {
