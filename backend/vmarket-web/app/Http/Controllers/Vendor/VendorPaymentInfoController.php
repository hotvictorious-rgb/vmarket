...
class VendorPaymentInfoController extends Controller
{
    ...
    public function update(PaymentInfoRequest $request): JsonResponse
    {
        return response()->json([
            'status' => false,
            'message' => translate('Withdrawal_methods_are_locked_upon_creation._Please_contact_Admin_to_edit.')
        ]);
    }
    ...
    {
        ToastMagic::error(translate("Withdrawal_methods_are_locked_upon_creation._Please_contact_Admin_to_delete."));
