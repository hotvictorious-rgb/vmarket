...
Route::group(['middleware' => ['maintenance_mode', 'guestCheck']], function () {
    ...
    Route::controller(UserProfileController::class)->group(function () {
        ...
        Route::get('account-address-add', 'account_address_add')->name('account-address-add')->middleware('customer');
        Route::get('account-address', 'account_address')->name('account-address')->middleware('customer');
        Route::post('account-address-store', 'address_store')->name('address-store')->middleware('customer');
        Route::get('account-address-delete', 'address_delete')->name('address-delete')->middleware('customer');
        Route::get('account-address-edit/{id}', 'address_edit')->name('address-edit')->middleware('customer');
        Route::post('account-address-update', 'address_update')->name('address-update')->middleware('customer');
        Route::get('account-payment', 'account_payment')->name('account-payment')->middleware('customer');
