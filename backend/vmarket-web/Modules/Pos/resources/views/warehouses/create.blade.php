...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h2 class="h4 mb-0 text-gray-800"><i class="fas fa-plus-circle me-2 text-primary"></i>Register New Branch</h2>
            <p class="text-muted small mb-0">Register a new warehouse or branch location to begin syncing physical counters and delivery hubs.</p>
        </div>
        ...
        <div class="col-lg-8 col-xl-6">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pos.warehouses.store') }}" method="POST" id="create-branch-form">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-lg @error('name') is-invalid @enderror" placeholder="e.g. Uyo Central Hub or Eket Branch" value="{{ old('name') }}" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="phone" id="phone" class="form-control form-control-lg @error('phone') is-invalid @enderror" placeholder="e.g. +2348012345678" value="{{ old('phone') }}">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="country_display" class="form-control form-control-lg bg-light" value="Nigeria" readonly disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="lga_id" id="lga_select" class="form-select form-select-lg @error('lga_id') is-invalid @enderror" required disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="hub_id" id="hub_select" class="form-select form-select-lg @error('hub_id') is-invalid @enderror" required disabled>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="address" id="address" rows="3" class="form-control form-control-lg @error('address') is-invalid @enderror" placeholder="e.g. Suite 4, Ewet Housing Estate Office Complex" required>{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg font-weight-bold py-3">
                                <i class="fas fa-save me-2"></i> Save Branch Location
                            </button>
