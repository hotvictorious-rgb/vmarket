        ...
        <div class="table-card">
            <div class="table-top-bar">
                ...
                <div style="display: flex; gap: 0.5rem;">
                    <a href="{{ route('pos.reports.export', 'sales') }}" class="btn btn-secondary" style="padding: 0.45rem 0.85rem; font-size: 0.75rem;">
                        📥 Export CSV
                    </a>
    ...
    @elseif($activeTab === 'stock_in')
        ...
        <div class="table-card">
            <div class="table-top-bar">
                ...
                <div style="display: flex; gap: 0.5rem;">
                    <a href="{{ route('pos.reports.export', 'stock') }}" class="btn btn-secondary" style="padding: 0.45rem 0.85rem; font-size: 0.75rem;">
                        📥 Export CSV
                    </a>
                </div>
            </div>
    ...
    @elseif($activeTab === 'in_transit')
        ...
        <div class="table-card">
            <div class="table-top-bar">
                ...
                <div style="display: flex; gap: 0.5rem;">
                    <a href="{{ route('pos.reports.export', 'transfers') }}" class="btn btn-secondary" style="padding: 0.45rem 0.85rem; font-size: 0.75rem;">
                        📥 Export CSV
                    </a>
                </div>
            </div>
    ...
    @elseif($activeTab === 'debts')
        ...
        <div class="table-card">
            <div class="table-top-bar">
                ...
                <div style="display: flex; gap: 0.5rem;">
                    <a href="{{ route('pos.reports.export', 'debtors') }}" class="btn btn-secondary" style="padding: 0.45rem 0.85rem; font-size: 0.75rem;">
                        📥 Export CSV
                    </a>
                </div>
            </div>
