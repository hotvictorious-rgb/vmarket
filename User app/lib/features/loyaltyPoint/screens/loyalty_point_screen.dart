...
class _LoyaltyPointScreenState extends State<LoyaltyPointScreen> {
  ...
  void initState() {
    ...
    if (Provider.of<AuthController>(context, listen: false).isLoggedIn()) {
      Provider.of<LoyaltyPointController>(context, listen: false)
          .getLoyaltyPointList(context, 1, isUpdate: false);
    }
  }
    ...
    return Scaffold(
        body: RefreshIndicator(
          ...
          child: NestedScrollView(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Selector<LoyaltyPointController,
                                  LoyaltyPointModel?>(
                                selector: (context, loyaltyController) =>
                                    loyaltyController.loyaltyPointModel,
                                builder: (context, loyaltyPointModel, _) {
                                  return FilterIconWidget(
                                    filterCount:
                                        _getFilterCount(loyaltyPointModel),
                                        ...
                                        : () {
                                            showModalBottomSheet(
                                              ...
                                              backgroundColor:
                                                  Colors.transparent,
                                              builder: (builder) =>
                                                  const LoyaltyFilterBottomSheetWidget(),
                                            );
                                          },
                                  );
                                },
            ...
            body: isGuestMode
                ? NotLoggedInWidget(fromPage: RouterHelper.loyaltyPointScreen)
                    ...
                    return (loyaltyPointController.loyaltyPointModel
                        ...
                        ? PaginatedListView(
                            ...
                            onPaginate: (int? offset) =>
                                loyaltyPointController.getLoyaltyPointList(
                              context,
                              offset ?? 1,
                              startDate: loyaltyPointController
                                  .loyaltyPointModel?.startDate,
                              endDate: loyaltyPointController
                                  .loyaltyPointModel?.endDate,
                              filterBy: loyaltyPointController
                                  .loyaltyPointModel?.filterBy,
                              transactionTypes: loyaltyPointController
                                  .loyaltyPointModel?.transactionTypes,
                            ),
                            ...
                            limit:
                                loyaltyPointController.loyaltyPointModel?.limit,
                            itemView: Expanded(
  ...
  int _getFilterCount(LoyaltyPointModel? loyaltyPointModel) {
    ...
    final int transactionTypesCount =
        loyaltyPointModel.transactionTypes?.length ?? 0;
