...
class ClearanceSearchBarWidget extends StatefulWidget {
  ...
  const ClearanceSearchBarWidget({super.key, this.showFilter = true, this.showBack = false, this.slug, this.fromShop = true, required this.controller, required this.applyFilter, required this.handleSearchText, required this.onSearchClick, required this.searchIcon});
