          ...
          child: Consumer<ProductDetailsController>(
            builder: (ctx, productDetailsController, child) {
              ...
              return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if((widget.product!.colors != null && widget.product!.colors!.isNotEmpty) || (widget.product!.choiceOptions != null && widget.product!.choiceOptions!.isNotEmpty))
                Container(
                      ...
                      Expanded(child: Consumer<SplashController>(builder: (context, configProvider,_) {
                        return CustomButton(
                          ...
                          onTap:() async {
                            ...
                            } else if(stock >= widget.product!.minimumOrderQty!) {
...
class QuantityButton extends StatelessWidget {
  ...
  const QuantityButton({super.key,
    ...
    required this.stock,
    this.isCartWidget = false, required this.minimumOrderQuantity,
  });
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(width: 40,height: 40,
          decoration: BoxDecoration(
            color:  (isIncrement && quantity! >= stock!) ?
