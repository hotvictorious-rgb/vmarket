...
abstract class SellerProductRepositoryInterface implements RepositoryInterface{
  ...
  Future<dynamic> getSellerProductList(String sellerId, String offset, String productId, {String search = '', String? categoryIds, String? brandIds, String? productType});
