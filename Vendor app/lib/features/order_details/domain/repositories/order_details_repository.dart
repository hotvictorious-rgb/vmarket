...
class OrderDetailsRepository implements OrderDetailsRepositoryInterface{
  ...
  @override
  Future<ApiResponse> getOrderInvoice(String orderID) async {
    try {
      final response = await dioClient!.get('${AppConstants.orderInvoice}$orderID', options: Options(responseType: ResponseType.bytes));
