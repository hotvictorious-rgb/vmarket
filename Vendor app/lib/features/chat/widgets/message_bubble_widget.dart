...
import 'package:sixvalley_vendor_app/features/chat/widgets/whatsapp_reaction_popup.dart';
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: (widget.message.message != null && isAudio(widget.message.message!))
                          ? AudioPlayerWidget(
